...
class Obrisi extends CI_Controller {
    ...
    public function obrisiVideo($vrednost) {
        $refering_url = isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : '';
        if ($refering_url == 'http://localhost/vunica.com/vunica/index.php/Pocetna') {
            
        } else if ($refering_url == 'http://localhost/vunica.com/vunica/index.php/Profil') {
            
        } else {
            $refering_url = 'http://localhost/vunica.com/vunica/index.php/Strikarnica';
        }
        $this->load->model('Obrisi_model');
    ...
    public function obrisiProizvod($vrednost) {
        ...
        if ($refering_url == 'http://localhost/vunica.com/vunica/index.php/Pocetna') {
            ...
            $refering_url = 'http://localhost/vunica.com/vunica/index.php/Pijaca';
        }
        $this->load->model('Obrisi_model');
