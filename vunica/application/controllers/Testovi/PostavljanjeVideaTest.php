...
class PostavljanjeVideaTest extends CI_Controller {
    ...
    public function adresa_Test(){
        $this->unit->run($this->adresa("D:/home/site/wwwroot/vunica/application/Video/Slika.jpg"), 'http://vunica.azurewebsites.net/vunica/application/Video/Slika.jpg', 'Testiranje putanje slike');
