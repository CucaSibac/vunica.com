...
<div id="upozorenje">
    <div id="naslovUpozorenje">Obavestenje</div>
    ...
    <table class="tabelaUpozorenje">
        <tr>
            ...
            <td colspan="2"><font id="tekstZaUpozorenje">&nbsp; </font></td>
            <td class="praznaCelijaPopUp">&nbsp;</td>
        </tr>  
        <tr>
            <td class="praznaCelijaPopUp">&nbsp;</td>
            <td class="celijaDugmePopUp"> <div  class="dugmePopUp" onclick="upozorenje_ok()"> Prijavi se!</div></td>
