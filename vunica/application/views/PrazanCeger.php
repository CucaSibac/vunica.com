                    ...
                    <tr>
                        <td align = "center">
                            <font class="naslovObican">
                                Dragi <?php echo $this->session->UserName; ?>
                            </font>
                            <br/> <br/>
                            <font class="tekstIskosen">
                                Nemate nijedan proizvod u cegeru!
                            </font>
                        </td>
                    </tr>
                </table>
                        ...
                        <tr>
                            <td align="center">
                                <font class = "tekstObican">
                                  Posetite našu pijacu na kojoj možete pazariti proizvode po povoljnim cenama!
                              </font>
                                <br/><br/>
                            </td>
                        </tr>
                    ...
                    <table align="center">
                        <tr>
                            <td width = "50%" align = "right">
                              <input type="button" value='Kupite proizvode' style="cursor: pointer;" onclick="window.open('http://localhost/vunica.com/vunica/index.php/Pijaca', '_parent')" class="dugme" />
                              &nbsp;
                            </td>
                            <td width = "50%" align = "left">
                              &nbsp;
                              <input type="button" value='Vratite se na početnu' style="cursor: pointer;" onclick="window.open('http://localhost/vunica.com/vunica/index.php/Pocetna', '_parent')" class="dugme" /> 
                            </td>
                        </tr>
                    </table>
                </div>
