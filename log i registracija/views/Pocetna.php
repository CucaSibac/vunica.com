...
<head>
  ...
  <!-- InstanceBeginEditable name="Head" -->
    ...
    <link rel="stylesheet" media="screen and (max-device-width: 1400px)"type="text/css" href="../CSS/Pocetna (1366x768).css">
    <link rel="stylesheet" media="screen and (min-device-width: 1401px)" type="text/css" href="../CSS/Pocetna (1920x1080).css">
           ...
           <td>
              ...
              <table width = "60%" align = "center">
                  ...
                  <tr>
                      <td width = "50%" valign = "top">
                        <br/>
                        <img class = "slikaKorisnika" src = "../Slike/Profilna/Slika.png">
                        <br/> <br/> <br/>
                      </td>
                      <td width = "50%" valign = "top">
                         <br/>
              ...
              <table width = "80%" align = "center">
              	<tr>
                	...
                	<td width = "22%">
                    	<img class = "videoThumb" src = "../Slike/Strikarnica/slika.jpg">
                        <br/> <br/>
                    </td>
                    <td width = "2%">
                    	<!--Prazna celija-->
              ...
              <table width = "80%" align = "center">
              	<tr>
                	...
                	<td width = "20%">
                    	<img class = "proizvodThumb" src="../Slike/Pijaca/slika.jpg">
                        <br/> <br/>
                    </td>
                    <td width = "4%">
                    	<!--Prazna celija-->
