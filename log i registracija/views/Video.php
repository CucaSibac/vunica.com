...
<head>
  ...
  <!-- InstanceBeginEditable name="doctitle" -->
    ...
    <link rel="stylesheet" media="screen and (min-device-wdsaidth: 1401px)" type="text/css" href="../CSS/Tekst (1920x1080).css">
...
<body onLoad="izracunaj();" onresize="izracunaj();" id="body">
   ...
   <div id="zaboravljenaLozinka">
    ...
    foreach($podaci as $red) {
        ?>
    <?php echo $red->UserName;} ?></a></font>
                </td>
                <td width="50%" align="right"><font class="tekstObican">Datum: <a href="#" class="linkovi"><?php
    
    foreach($podaci as $red) {
        ?>
    <?php echo $red->Datum;} ?></a></font>
                </td>
              </tr> 
              <tr>
              <td colspan="2" align="center"> <video width="100%" controls> <source src="http://localhost/vunica/CodeIgniter-3.0.0/index.php/vunica/Video/../Video/Omca.mp4" type="video/mp4"></video></td>
              </tr>  
              <tr>
    ...
    foreach($podaci as $red) {
        ?>
    <?php echo $red->Kategorija;} ?></a></font>
              </td>
              <tr>     
              <tr>
              ...
              <br /><textarea  maxlength="400" style="width:80%; height:120px; resize:none;text-align: justify;"placeholder="Napisite komentar" class="tekstPoljeKomentar" id="limitedtextarea" onKeyDown="limitText(400);" 
onKeyUp="limitText(400);">
</textarea><br>
...
<a class="dugme" onclick="postavi()" > Postavi </a> 
                ...
                <table width = "100%" align = "center">
                	<tr >
                        ...
                        <td width = "8%" align="center">
                        	<img src = "../Slike/Linija/Ikonica.png" class = "ikonica">
                        </td>
                        <td width = "46%">
                        	<hr width = "100%" class = "linija"/>
                        </td>
                ...
                <a class="komentarDatum">16:28&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;08.05.2015.</a>
				<font class="tekstObicanAutorKomentar"  ><a class="linkovi" href="#">ZikinaMama</a></font>
                <br /><br />
                <font class="tekstIskosenTekstKomentar" >Svaka boja ima svoju vibraciju, svaka vibracija ima svoj ton, svaki ton ima svoje znacenje i svaka izgovorene rec ima svoju neku svetlosu formulu.<br /><br /></font>
			<a href="#" class="prijaviKomentar">Prijavi komentar</a>
                ...
                <div class="view view-third" align="left"> 
                <a class="komentarDatum">14:32&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;08.05.2015.</a> 
				<font class="tekstObicanAutorKomentar"  ><a class="linkovi" href="#">Zika</a></font>
                <br /><br />
                <font class="tekstIskosenTekstKomentar" >Ovo je poslednji video moje mame. Ovo je poslednji video moje mame. Ovo je poslednji video moje mame. la la la<br /><br /></font>
				<a href="#" class="prijaviKomentar">Prijavi komentar</a>  
		</div>  
                </td>
                </tr>
                ...
                <td colspan="2">
                <br /><br /><br />
                 <div class="" target="_blank" align="center" width="100%">
				
                
                	<a id="" class="btnUcitajJos" style="display:block; " href="#" onClick="ucitajjos()" >
                    	<i id="" class="" >
                        	Ucitaj jos
                        </i>
                    </a>
    ...
    <div id="footer" >
      ...
      <table id = "footerGornji" onmouseover="show()" onmouseout="hide()" align="center">
      	<tr >
            ...
            <td id = "klupkoPolje" >
            	<img src = "../Slike/Vunica/Klupko.png" id = "klupko"/>
                <br/>
            ...
            <td  class = "footerPolje" >
                ...
                <a href = "https://www.facebook.com/" target = "_blank" style = "text-decoration:none">
                	<img src = "../Slike/Footer/Facebook 1.png" width = "42px" style = "padding:8px 5px 0 2px;"/>
                </a>
                <a href = "https://twitter.com/" target = "_blank" style = "text-decoration:none">
                	<img src = "../Slike/Footer/Twitter 1.png" width = "42px" style = "padding:8px 5px 0 2px;"/>
                </a>
				<a href = "https://www.youtube.com/" target = "_blank" style = "text-decoration:none">
                	<img src = "../Slike/Footer/YouTube 1.png" width = "42px" style = "padding:8px 5px 0 2px;"/>
                </a>
            </td>
            <td width = "10%" valign = "top" align = "right">
            	<!-- Prazna celija --> 
      ...
      <table id = "footerDonji" onmouseover="show()">
          <tr>
              <td width = "15%" align = "left">
                  <!-- Bivsa prazna celija -->                  
                  <img id = "levaStrelica" class = "strelica" src = "../Slike/Footer/Strelica.png">
              </td>
              <td width = "15%">
              	<font> 2015 </font>
              </td>
              ...
              <td width = "15%" align = "right">
              	<!-- Bivsa prazna celija --> 
                <img id = "desnaStrelica" class = "strelica" src = "../Slike/Footer/Strelica.png">
              </td>
          </tr>
      </table>
